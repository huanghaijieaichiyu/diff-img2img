...
def _specs(benchmark_steps: int) -> dict[str, ExperimentSpec]:
    ...
    return {
        ...
        "small_phase_b_batch4": ExperimentSpec(
            ...
            description="Compile-safe throughput small preset challenger with batch_size=4 / grad_accum=4 if VRAM allows.",
        ...
        "small_phase_b_batch2_accum8": ExperimentSpec(
            ...
            config_name="small_throughput",
            description="Fallback compile-safe throughput small challenger with batch_size=2 / grad_accum=8 to keep effective batch >= 16.",
            max_train_steps=phase_b_steps,
